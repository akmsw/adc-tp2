...
HD_PWD='C:/Users/lihue/project_7/project_7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log alu_uart_interface.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source alu_uart_interface.tcl
